  ...
  <section class="demo-card">
    ...
    <div class="demo-meta">
      <div class="demo-actions">
        <button class="action-btn" @click="expanded = !expanded" :title="expanded ? 'Hide Code' : 'Show Code'"
        ...
        <button class="action-btn" @click="onCopy" title="Copy Code" :class="{ copied: isCopied }">
          <svg v-if="!isCopied" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
        ...
        <a class="action-btn" href="https://codesandbox.io/" target="_blank" title="Open in CodeSandbox">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round">
            <path
...
const activeDemo = computed(() => props.demos[activeIndex.value] ?? props.demos[0])
