...
export const demos: DemoItem[] = [
  {
    key: 'basic',
    title: '基本用法',
    description: '按钮分为 主要按钮、次要按钮、虚线按钮、线形按钮和文本按钮五种。',
    component: Basic,
    lang: 'vue',
    code: BasicCode
  },
  {
    key: 'size',
    title: '按钮尺寸',
    description: '按钮分为 mini、small、default、large 四种尺寸。高度分别为：24px、28px、32px、36px。推荐（默认）尺寸为 default。',
    component: Size,
    lang: 'vue',
    code: SizeCode
  },
  ...
  },
  {
    key: 'status',
    title: '按钮状态',
    description: '状态支持 warning、danger、success，可与按钮类型叠加，状态优先级高于类型。',
    component: Status,
    lang: 'vue',
    code: StatusCode
  },
